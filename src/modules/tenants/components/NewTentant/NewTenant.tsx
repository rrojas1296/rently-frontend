...
const steps: Step[] = [
  {
    label: "NewTenant.steps.tenantInformation",
  },
  {
    label: "NewTenant.steps.contactInformation",
  },
  {
    label: "NewTenant.steps.contractInformation",
  },
];
      ...
      <div className="lg:max-w-3xl w-full">
        <div className="flex flex-col gap-px">
          ...
          <p className="text-sm text-text-2 lg:text-center">
            {t("NewTenant.description")}
          </p>
        </div>
        <Stepper
          steps={steps.map((s) => ({ label: t(s.label) }))}
          currentStep={currentStep}
          labelClassName="hidden lg:block w-32"
